...
def load_data_into_db():
    ...
    try:
        ...
        df_lead_scoring = pd.read_csv(DATA_DIRECTORY+LEAD_SCORING_INFERENCE_FILE, index_col=[0])
...
def interactions_mapping():
    ...
    try:
        ...
        df_pivot = df.pivot_table(values='interaction_value', 
                                  index=INDEX_COLUMNS_INFERENCE, columns='interaction_mapping', aggfunc='sum')
        ...
        df_selected_features = df_pivot[INDEX_COLUMNS_INFERENCE[1:]]
